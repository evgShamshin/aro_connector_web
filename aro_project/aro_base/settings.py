...
"""
Django settings for aro_project project.
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'aro_app.apps.WebsiteAppConfig',
    'aro_users.apps.WebsiteUsersConfig',
    'debug_toolbar',
    'social_django',
...
MIDDLEWARE = [
    ...
    'aro_app.middleware.ColoredStatusMiddleware',
]

CACHE_MIDDLEWARE_ALIAS = 'default'
CACHE_MIDDLEWARE_SECONDS = 15
CACHE_MIDDLEWARE_KEY_PREFIX = 'website-app'

ROOT_URLCONF = 'aro_project.urls'
...
WSGI_APPLICATION = 'aro_project.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    ...
    "aro_users.authenticate.MyBackend"
]
